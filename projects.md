...
-   Summary: The project aims to develop an automatic, data-driven tool to detect atypical distortions in electricity markets, particularly those caused by the exercise of market power by dominant energy companies. The tool operates online, uses only publicly available data, is computationally efficient, and learns to explain the conditions under which distortions are likely to occur. Its scientific core relies on Functional Statistics and innovative methods for identifying functional outliers, developed in the ERC-STG project FlexAnalytics. By equipping market regulators and operators with this tool, the project seeks to enhance their ability to monitor markets in real time, detect potential abuses faster, and reduce supervision costs. Ultimately, it strives to protect consumers and ensure the transparency, fairness, and stability of the electricity sector—a cornerstone of modern society.
-   Dates: 01/01/2026 - 30/06/2027
-   Funding Amount: 150.000€
-   Funding Entity: European Research Council (ERC-POC-2025)
-   PI: J.M. Morales – University of Malaga
